...
Subject-selected changed identities and closure-retained structural paths
receive provider-owned claim provenance for assessment. Predicate assessment
still admits a seed only for the exact selector that selected it, and alignment
does not decide whether path step order satisfies an ordered predicate.
