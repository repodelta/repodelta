...
from prismcode.llm.admission import ShadowCandidateAdmission
...
<p>This report compares frozen deterministic evidence, validated LLM shadow output, and independent human dispositions. It does not change PrismCode assessment or mergeability.</p>
