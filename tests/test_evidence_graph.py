...
def test_catalog_deduplicates_facts_and_links_unchanged_path_symbols() -> None:
    ...
    assert catalog.schema_version == "evidence_catalog.v14"
...
def test_review_brief_serializes_one_canonical_catalog() -> None:
    ...
    assert brief.schema_version == "review_brief.v31"
    assert serialized["evidence_catalog"]["schema_version"] == "evidence_catalog.v14"
    ...
    assert serialized["projection"]["schema_version"] == "review_projection.v14"
