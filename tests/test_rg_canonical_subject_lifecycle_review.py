...
SCRIPT = (
    ...
    "run_pr208_canonical_subject_lifecycle_review.py"
)
PLAN = (
    ROOT
    / "evaluations/structural-correctness/campaign-v1-1/rg-semantic-labeling-runs/"
    "pr-208.batch-001.canonical-subject-lifecycle-plan.json"
)


def _module():
    spec = importlib.util.spec_from_file_location("rg_canonical_subject_lifecycle", SCRIPT)
